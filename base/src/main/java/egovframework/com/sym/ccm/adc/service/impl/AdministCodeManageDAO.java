...
public class AdministCodeManageDAO extends EgovAbstractDAO {
	...
	public AdministCode selectAdministCodeDetail(AdministCode administCode) throws Exception {
		return (AdministCode) selectByPk("AdministCodeManageDAO.selectAdministCodeDetail", administCode);
	}
    ...
    public int selectAdministCodeListTotCnt(AdministCodeVO searchVO) throws Exception {
        return (Integer)getSqlMapClientTemplate().queryForObject("AdministCodeManageDAO.selectAdministCodeListTotCnt", searchVO);
    }
