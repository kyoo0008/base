...
public class CommunityManageDAO extends EgovAbstractDAO {
    ...
    public String selectCmmntyFindId(String cmmntyAdres) throws Exception {
    	return (String)selectByPk("CommunityManageDAO.selectCmmntyFindId", cmmntyAdres);
    }
	...
	return list("CommunityManageDAO.selectCommunityInfs", cmmntyVO);
    }
	...
	// 사용되지 않음
	return list("CommunityManageDAO.selectCommunityUserInfs", cmmntyUserVO);
    }
	...
	return list("CommunityManageDAO.selectCommunityBBSUseInf", cmmntyVO);
    }
	...
	return list("CommunityManageDAO.selectCommunityMenuList", cmmntyVO);
    }
	...
	return (CommunityVO)selectByPk("CommunityManageDAO.selectCommunityInfo", cmmntyVO);
    }
	...
	return list("CommunityManageDAO.selectCmmntyListPortlet", cmmntyVO);
    }
	...
	return list("CommunityManageDAO.selectAllCmmnty", cmmntyVO);
    }
	...
	return list("CommunityManageDAO.selectCommunityManagerInf", cmmnty);
    }
	...
	public List<AuthorManageVO> selectAuthorAllList(AuthorManageVO authorManageVO) throws Exception {
        return list("CommunityManageDAO.selectAuthorAllList", authorManageVO);
    }    
    ...
    public int checkCmmntyNmDplct(CommunityVO cmmntyVO){
        return (Integer)getSqlMapClientTemplate().queryForObject("CommunityManageDAO.checkCmmntyNmDplct", cmmntyVO);
    }
    ...
    public int checkCmmntyAdresDplct(CommunityVO cmmntyVO){
        return (Integer)getSqlMapClientTemplate().queryForObject("CommunityManageDAO.checkCmmntyAdresDplct", cmmntyVO);
    }
    ...
    public CommunityMnu selectCommunityMnuSortOrdr(CommunityMnu cmmntyMnu) throws Exception {
    	return (CommunityMnu)selectByPk("CommunityManageDAO.selectCommunityMnuSortOrdr", cmmntyMnu);
    }
	...
	return list("CommunityManageDAO.selectMyCmmntyList", cmmntyUser);
    }
	...
	return list("CommunityManageDAO.selectCmmntyBBSMasterInfs", cmmntyMnu);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("CommunityManageDAO.selectCmmntyBBSMasterInfsCnt", cmmntyMnu);
    }
    ...
    public CommunityMnu selectCmmntyBBSMasterInf(CommunityMnu vo) throws Exception {
    	return (CommunityMnu)selectByPk("CommunityManageDAO.selectCmmntyBBSMasterInf", vo);
    }
	...
	return list("CommunityManageDAO.selectCommunityBbsMaster", cmmntyVO);
    }
    ...
    public List<BoardVO> selectCommunityBoardMyArticles(CommunityVO cmmntyVO) throws Exception {
    	return list("CommunityManageDAO.selectCommunityBoardMyArticles", cmmntyVO);
    }
    ...
    public List<BoardVO> selectCommunityBoardAllArticles(CommunityVO cmmntyVO) throws Exception {
    	return list("CommunityManageDAO.selectCommunityBoardAllArticles", cmmntyVO);
    }
    ...
    public int selectCommunityBoardAllArticlesCnt(CommunityVO cmmntyVO) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("CommunityManageDAO.selectCommunityBoardAllArticlesCnt", cmmntyVO);
    }
    ...
    public List<BoardVO> selectBoardNewArticles(BoardVO boardVO) throws Exception {
    	return list("CommunityManageDAO.selectBoardNewArticleList", boardVO);
    }
    ...
    public List<BoardVO> selectCmmntyBoardArticles(BoardVO boardVO) throws Exception {
    	return list("CommunityManageDAO.selectBoardArticleList", boardVO);
    }
    ...
    public List<BoardVO> selectSearchCommunityBoardArticleList(BoardVO boardVO) throws Exception {
    	return list("CommunityManageDAO.selectSearchCommunityBoardArticleList", boardVO);
    }
    ...
    public int selectSearchCommunityBoardArticleListCnt(BoardVO boardVO) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("CommunityManageDAO.selectSearchCommunityBoardArticleListCnt", boardVO);
    }
    ...
    public List<BoardVO> selectSearchCommunityNotifyArticleList(BoardVO boardVO) throws Exception {
    	return list("CommunityManageDAO.selectSearchCommunityNotifyArticleList", boardVO);
    }
    ...
    public int selectSearchCommunityNotifyArticleListCnt(BoardVO boardVO) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("CommunityManageDAO.selectSearchCommunityNotifyArticleListCnt", boardVO);
    }
    ...
    public List<BoardVO> selectSearchCommunityNotifyUrlList(BoardVO boardVO) throws Exception {
    	return list("CommunityManageDAO.selectSearchCommunityNotifyUrlList", boardVO);
    }
}
