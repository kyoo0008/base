...
public class CommunityVO extends Community implements Serializable {
    ...
    /**
	 * searchUse attribute를 리턴한다.
	 * @return  the searchUse
	 */
    ...
    /**
	 * searchUse attribute 값을 설정한다.
	 * @param searchUse  the searchUse to set
	 */
	 ...
	 * @param mngr  the resultCode to resultCode
	 */
