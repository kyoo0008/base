...
public class BBSCommentDAO extends EgovAbstractDAO {
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("BBSCommentDAO.selectMyCommentListCnt", commentVO);
    }
    ...
    public List<CommentVO> selectCommentManageCopyList(CommentVO commentVO) throws Exception {
    	return list("BBSCommentDAO.selectCommentManageCopyList", commentVO);
    }
