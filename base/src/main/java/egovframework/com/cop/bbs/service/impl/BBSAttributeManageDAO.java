...
public class BBSAttributeManageDAO extends EgovAbstractDAO {
  ...
  return (BoardMasterVO)selectByPk("BBSAttributeManageDAO.selectBBSMasterInf", vo);
	...
	return list("BBSAttributeManageDAO.selectAllBBSMasterManageInfs", vo);
    }
	...
	return (Integer)getSqlMapClientTemplate().queryForObject("BBSAttributeManageDAO.selectAllBBSMasterManageInfsCnt", vo);
    }
