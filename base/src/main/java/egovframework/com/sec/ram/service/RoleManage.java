...
public class RoleManage extends ComDefaultVO {
	...
	/**
	 * 롤 관리
	 * @uml.property  name="roleManage"
	 * @uml.associationEnd  
	 */
	private RoleManage roleManage;
	/**
	 * 롤코드
	 * @uml.property  name="roleCode"
	 */
	private String roleCode;
	/**
	 * 롤명
	 * @uml.property  name="roleNm"
	 */
	private String roleNm;	
	/**
	 * 롤패턴
	 * @uml.property  name="rolePtn"
	 */
	private String rolePtn;	
	/**
	 * 롤 설명
	 * @uml.property  name="roleDc"
	 */
	private String roleDc;		
	/**
	 * 롤 타입
	 * @uml.property  name="roleTyp"
	 */
	private String roleTyp;		
	/**
	 * 롤 Sort
	 * @uml.property  name="roleSort"
	 */
	private String roleSort;
	/**
	 * 롤 등록일시
	 * @uml.property  name="roleCreatDe"
	 */
