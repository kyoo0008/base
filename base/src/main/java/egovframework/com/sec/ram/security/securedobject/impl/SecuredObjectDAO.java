package egovframework.com.sec.ram.security.securedobject.impl;
...
public class SecuredObjectDAO {
    ...
    */
    ...
    /**
	 * @uml.property  name="sqlRolesAndUrl"
	 */
    private String sqlRolesAndUrl;

    /**
	 * @uml.property  name="sqlRolesAndMethod"
	 */
    private String sqlRolesAndMethod;

    /**
	 * @uml.property  name="sqlRolesAndPointcut"
	 */
    private String sqlRolesAndPointcut;

    /**
	 * @uml.property  name="sqlRegexMatchedRequestMapping"
	 */
    private String sqlRegexMatchedRequestMapping;

    /**
	 * @uml.property  name="sqlHierarchicalRoles"
	 */
    ...
    /**
	 * @uml.property  name="namedParameterJdbcTemplate"
