...
public class RssDao extends EgovAbstractDAO {
    ...
    public List selectRssTagServiceTable(Map param) throws Exception {
    	return (List)list("RssTagService.selectRssTagServiceTable",param);
    }
    ...
    public List selectRssTagServiceList(RssInfo rssInfo) throws Exception {
    	return (List)list("RssTagService.selectRssTagService",rssInfo);
    }
    ...
    public int selectRssTagServiceListCnt(RssInfo rssInfo) throws Exception {
    	return (Integer)getSqlMapClientTemplate().queryForObject("RssTagService.selectRssTagServiceCnt", rssInfo);
    }
    ...
    public Map selectRssTagServiceDetail(RssInfo rssInfo) throws Exception {
    	return (Map)getSqlMapClientTemplate().queryForObject("RssTagService.selectRssTagServiceDetail", rssInfo);
    }
