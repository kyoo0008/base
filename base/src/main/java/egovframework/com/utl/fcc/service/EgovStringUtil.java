...
/**
     ...
     * @return
     */
    public static String getNoneHtml(String tagString) {
    	if(tagString != null) {
    		return tagString.replaceAll("<(/)?([a-zA-Z]*)(\\s[a-zA-Z]*=[^>]*)?(\\s)*(/)?>", "").replaceAll("&nbsp;", " ").trim();
    	}
    	return null;	
    }
     ...
     * @return
     */
    public static String byteConverter(String str) {
    	String result = str + " B";
    	try {
	    	double byteCount = Double.parseDouble(str);
	    	
	    	String size = "0 KB";
	    	if (byteCount >= 1073741824)
                size = decimalFormat(byteCount / 1073741824) + " GB";
            else if (byteCount >= 1048576)
                size = decimalFormat(byteCount / 1048576) + " MB";
            else if (byteCount >= 1024)
                size = decimalFormat(byteCount / 1024) + " KB";
