...
<script type="text/javascript">
	...
	function fn_egov_select_userLog(pageNo){
		...
		document.frm.action = "<c:url value='/sym/log/SelectUserLogList.do'/>";
		document.frm.submit();	
	}
	
	function fn_egov_inqire_userLog(occrrncDe, rqesterId, srvcNm, methodNm){
		var url = "/sym/log/InqireUserLog.do?occrrncDe="+occrrncDe+"&rqesterId="+rqesterId+"&srvcNm="+srvcNm+"&methodNm="+methodNm;
...
<body>
<form name="frm" action ="<c:url value='/sym/log/SelectUserLogList.do'/>" method="post">
<input type="hidden" name="cal_url" value="<c:url value='/sym/cmm/EgovNormalCalPopup.do'/>" />

 <table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td class="title_left">
	   <img src="<c:url value='/images/egovframework/sym/log/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle">&nbsp;사용자 로그조회</td>
	  <th>
	   발생일자
	  </th>
	  <td>
	  ...
	  <th>
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr> 
	      ...
	      <a href="javascript:fn_egov_select_userLog('1')">조회</a> 
	      </td>
	...
	<table width="700" cellpadding="8" class="table-line">
	 ...
	 <c:forEach var="result" items="${resultList}" varStatus="status">
	  <tr>
	    ...
	    <td class="lt_text3" nowrap><c:out value="${result.inqireCo}"/></td>
  ...
  <tr> 
	...
	<div align="center">
		<ui:pagination paginationInfo = "${paginationInfo}"
				type="image"
				jsFunction="fn_egov_select_userLog"
				/>
	</div>
