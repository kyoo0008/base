...
<script type="text/javascript">
	...
	function fn_egov_add_trsmrcvLog(){
		document.frm.action = "<c:url value='/sym/log/AddTrsmrcvLog.do'/>";
		document.frm.submit();	
	}
	
	function fn_egov_inqire_trsmrcvLog(requstId){
		var url = "/sym/log/InqireTrsmrcvLog.do?requstId="+requstId;
...
<body>
<form name="frm" action ="<c:url value='/sym/log/SelectTrsmrcvLogList.do'/>" method="post">
<input type="hidden" name="cal_url" value="<c:url value='/sym/cmm/EgovNormalCalPopup.do'/>" />

 <table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td class="title_left">
	   <img src="<c:url value='/images/egovframework/sym/log/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle">&nbsp;송수신 로그조회</td>
	  <th>
	   발생일자
	  </th>
	  <td>
	  ...
	  <th>
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr> 
	      ...
	      <a href="javascript:fn_egov_select_trsmrcvLog('1')">조회</a> 
	      </td>
	...
	<table width="700" cellpadding="8" class="table-line">
	 <thead>
	  <tr>
	    ...
	    <th class="title" width="10%" nowrap>송수신구분</th>
	    <th class="title" width="15%" nowrap>연계ID</th>
	    <th class="title" width="10%" nowrap>제공기관ID</th>
	    <th class="title" width="10%" nowrap>요청기관ID</th>
	 ...
	 <c:forEach var="result" items="${resultList}" varStatus="status">
	  <tr>
	    ...
	    <td class="lt_text3" nowrap><c:out value="${result.integId}"/></td>
	    ...
	    <a href="javascript:fn_egov_inqire_trsmrcvLog('<c:out value="${result.requstId}"/>');" 
  ...
  <tr> 
	...
	<div align="center">
		<ui:pagination paginationInfo = "${paginationInfo}"
				type="image"
				jsFunction="fn_egov_select_trsmrcvLog"
				/>
	</div>
