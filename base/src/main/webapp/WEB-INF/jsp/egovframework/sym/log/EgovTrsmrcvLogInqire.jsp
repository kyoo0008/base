...
<body>
	<table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	   <img src="<c:url value='/images/egovframework/sym/log/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle">&nbsp;송수신 로그 정보</td>
	 </tr>
	</table>
	<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register">
	 ...
	 <tr> 
	    <th width="20%" height="23" align="center">송수신구분</th>
	    <td width="80%" nowrap >&nbsp;&nbsp;
	      <c:out value="${result.trsmrcvSeCodeNm}"/>
	    </td>
	  </tr>
	 <tr> 
	    <th width="20%" height="23" align="center">연계ID</th>
	    <td width="80%" nowrap >&nbsp;&nbsp;
	      <c:out value="${result.integId}"/>
	    </td>
	  </tr>
	 <tr> 
	    <th width="20%" height="23" align="center">제공기관ID</th>
	    <td width="80%" nowrap >&nbsp;&nbsp;
	      <c:out value="${result.provdInsttId}"/>
	    </td>
	  </tr>
	 <tr> 
	    <th width="20%" height="23" align="center">제공시스템ID</th>
	    <td width="80%" nowrap >&nbsp;&nbsp;
	      <c:out value="${result.provdSysId}"/>
	    </td>
	  </tr>
	 <tr> 
	    <th width="20%" height="23" align="center">제공서비스ID</th>
	    <td width="80%" nowrap >&nbsp;&nbsp;
	      <c:out value="${result.provdSvcId}"/>
	    </td>
	  </tr>
	 <tr> 
	    <th width="20%" height="23" align="center">요청기관ID</th>
	    <td width="80%" nowrap >&nbsp;&nbsp;
	      <c:out value="${result.requstInsttId}"/>
	    </td>
	  </tr>
	 <tr> 
	    <th width="20%" height="23" align="center">요청시스템ID</th>
	    <td width="80%" nowrap >&nbsp;&nbsp;
