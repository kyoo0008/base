...
<script type="text/javascript">
	...
	function fn_egov_select_loginLog(pageNo){
		...
		document.frm.action = "<c:url value='/sym/log/SelectLoginLogList.do'/>";
		document.frm.submit();	
	}
	
	function fn_egov_inqire_loginLog(logId){
		var url = "/sym/log/InqireLoginLog.do?logId="+logId;
...
<body>
<form name="frm" action ="<c:url value='/sym/log/SelectLoginLogList.do'/>" method="post">
<input type="hidden" name="cal_url" value="<c:url value='/sym/cmm/EgovNormalCalPopup.do'/>" />

 <table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td class="title_left">
	   <img src="<c:url value='/images/egovframework/sym/log/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle">&nbsp;로그인 로그조회</td>
	  <th>
	   발생일자
	  </th>
	  <td>
