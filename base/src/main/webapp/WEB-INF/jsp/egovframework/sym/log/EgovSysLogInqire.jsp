...
<body>
	<table width="700" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	   <img src="<c:url value='/images/egovframework/sym/log/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="absmiddle">&nbsp;시스템 로그 정보</td>
	 </tr>
	</table>
	<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register">
	 ...
	 <tr> 
	    <th width="20%" height="23" align="center">처리구분</th>
	    <td width="80%" nowrap >&nbsp;&nbsp;
	      <c:out value="${result.processSeCodeNm}"/>
	    </td>
	  </tr>
	 <tr> 
	    <th width="20%" height="23" align="center">처리시간</th>
	    <td width="80%" nowrap >&nbsp;&nbsp;
