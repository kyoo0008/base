...
<c:set var="_IMG" value="${pageContext.request.contextPath}${BbsFileStoreWebPathByWebFile}${brdMstrVO.tmplatId }/images"/>
		...
		<div class="board_write">
			<dl>
				...
				<c:otherwise>
					...
					<!-- 링크주소  -->
					<dt><label>링크주소</label></dt>
					<dd><form:input path="tmp01" cssClass="inp tit" /></dd>
