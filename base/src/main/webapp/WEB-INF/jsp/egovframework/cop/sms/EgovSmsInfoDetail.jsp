...
<link href="<c:url value='/css/egovframework/cop/sms/com.css' />" rel="stylesheet" type="text/css">
<link href="<c:url value='/css/egovframework/cop/sms/button.css' />" rel="stylesheet" type="text/css">
...
<div id="border" style="width:730px">
	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%" class="title_left">
	   <img src="<c:url value='/images/egovframework/cop/sms/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">
	   &nbsp;문자메시지 상세조회</td>
	 </tr>
	</table>
	...
	<tbody>
	  <tr> 
	    <th width="15%" height="23" nowrap class=""><spring:message code="cop.sms.trnsmitTelno" /></th>
	    <td width="85%" colspan="3" nowrap><c:out value="${result.trnsmitTelno}" />
	    </td>
	  </tr>
	  <tr> 
	    <th height="23" class=""><spring:message code="cop.sms.trnsmitCn" /></th>
	    <td colspan="3">
	  ...
	  <tr> 
	    <th width="15%" height="23" nowrap class="">수신 및 전송결과</th>
	  ...
	  <tr> 
	    <th width="15%" height="23" nowrap class="">전송자</th>
	    <td width="15%" class="lt_text3" nowrap>
	   		<c:out value="${result.frstRegisterNm}" />
	    </td>
	    <th width="15%" height="23" nowrap class="">전송시간</th>
