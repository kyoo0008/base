...
<div id="border" style="width:730px">
	...
	<table width="100%" cellpadding="8" class="table-search" border="0">
	 <tr>
	  <td width="100%"class="title_left">
	   <img src="<c:url value='/images/egovframework/cop/sms/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;문자메시지 전송</td>
	 </tr>
	</table>
	...
	<tbody>
	  <tr> 
	    ...
	    <img src="<c:url value='/images/egovframework/cop/sms/icon/required.gif' />" width="15" height="15" alt="required"></th>
