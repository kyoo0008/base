...
<body style="background:none;">	
	<div style="width:370px; padding:8px 40px 80px; font-size:12px; background:url(${_IMG}/popuptem051_450_bg.jpg) no-repeat left bottom;">		
		<p style="margin:-8px -40px 0;">
			<img src="${_IMG}/popuptem051_450_img.jpg"/>
		</p>
		<h1 style="margin-bottom:20px; color:#207000; font-size:14px;"><c:out value="${popupManageVO.popupTitleNm}"/></h1>
