...
<body style="background:none;">	
	<div style="width:325px; padding:8px 30px 80px; font-size:12px; background:url(${_IMG}/popuptem055_385_bg.jpg) no-repeat left bottom;">		
		<p style="margin:-8px -30px 0;">
			<img src="${_IMG}/popuptem055_385_img.jpg"/>
		</p>
		<h1 style="margin-bottom:20px; color:#a71d20; font-size:14px;"><c:out value="${popupManageVO.popupTitleNm}"/></h1>
