...
<body style="background:none;">	
	<div style="width:355px; padding:8px 15px 50px; font-size:12px;  left bottom;">		
		<p style="margin:-8px -15px 0;">
			<img src="${_IMG}/popuptem059_385_img.jpg"/>
		</p>
		<h1 style="margin-bottom:20px; color:#333333; font-size:14px;"><c:out value="${popupManageVO.popupTitleNm}"/></h1>
