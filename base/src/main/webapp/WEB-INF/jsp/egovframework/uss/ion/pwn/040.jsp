...
<body style="background:none;">
	<div style="width:470px; padding:50px 30px 0; font-size:12px; background:url(${_IMG}/common/popuptem_530_bg.jpg) no-repeat left top;">
		<h1 style="margin-bottom:20px; color:#da6d15; font-size:14px;"><c:out value="${popupManageVO.popupTitleNm}"/></h1>
		<div style="width:370px;">
			<c:out value="${popupManageVO.popupCn}" escapeXml="false" />
		</div>
		<p style="margin:0 -30px;"><img src="${_IMG}/common/popuptem_530_img.jpg" alt="edus 충남" /></p>
	</div>
