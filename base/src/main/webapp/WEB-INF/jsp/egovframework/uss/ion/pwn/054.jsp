...
<body style="background:none;">	
	<div style="width:360px; padding:8px 40px 150px; font-size:12px; background:url(${_IMG}/popuptem054_440_bg.jpg) no-repeat left bottom;">		
		<p style="margin:-8px -40px 0;">
			<img src="${_IMG}/popuptem054_440_img.jpg"/>
		</p>
