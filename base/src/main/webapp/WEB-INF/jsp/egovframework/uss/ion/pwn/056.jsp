...
<body style="background:none;">	
	<div style="width:460px; padding:8px 30px 150px; font-size:12px; background:url(${_IMG}/popuptem056_520_bg.jpg) no-repeat left bottom;">		
		<p style="margin:-8px -30px 0;">
			<img src="${_IMG}/popuptem056_520_img.jpg"/>
		</p>
		<h1 style="margin-bottom:20px; color:#084700; font-size:14px;"><c:out value="${popupManageVO.popupTitleNm}"/></h1>
