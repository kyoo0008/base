...
<body style="background:none;">	
	<div style="width:400px; padding:8px 60px 150px; font-size:12px; background:url(${_IMG}/popuptem058_520_bg.jpg) no-repeat left bottom;">		
		<p style="margin:-8px -60px 0;">
			<img src="${_IMG}/popuptem058_520_img.jpg"/>
		</p>
		<h1 style="margin-bottom:20px; color:#075967; font-size:14px;"><c:out value="${popupManageVO.popupTitleNm}"/></h1>
