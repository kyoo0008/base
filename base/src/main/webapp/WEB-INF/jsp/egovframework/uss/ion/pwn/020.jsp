...
<body style="background:none;">
	...
	<div style="width:389px; padding:18px 28px 28px; font-size:12px; background:url(${_IMG}/common/popuptem_445_bg.jpg) no-repeat left top;">
		<h1 style="margin:0 0 35px -12px; color:#fff; font-size:14px;"><c:out value="${popupManageVO.popupTitleNm}"/></h1>
		<div style="width:295px">
			<c:out value="${popupManageVO.popupCn}" escapeXml="false" />
		</div>
		<p style="margin:0 -28px -28px;"><img src="${_IMG}/common/popuptem_445_img.jpg" alt="edus 충남" /></p>
	</div>
