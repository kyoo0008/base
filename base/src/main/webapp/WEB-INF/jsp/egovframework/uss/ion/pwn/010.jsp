...
<body style="background:none;">
	...
	<div style="width:340px; padding:8px 30px 150px; font-size:12px; background:url(${_IMG}/common/popuptem_400_bg.jpg) no-repeat left bottom;">
		<p style="margin:-8px -30px 0;"><img src="${_IMG}/common/popuptem_400_img.jpg" alt="" /></p>
