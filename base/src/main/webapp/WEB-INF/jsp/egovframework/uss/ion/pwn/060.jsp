...
<body style="background:none;">	
	<div style="width:320px; padding:8px 60px 150px; font-size:12px; background:url(${_IMG}/popuptem060_440_bg.jpg) no-repeat left bottom;">		
		<p style="margin:-8px -60px 0;">
			<img src="${_IMG}/popuptem060_440_img.jpg"/>
		</p>
