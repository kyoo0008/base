...
<form name="listForm" action="<c:url value='${_PREFIX}/EgovCcmCmmnClCodeList.do'/>" method="post">
	...
	<table class="chart_board">
		...
		<tr>
			<td class="lt_text3" nowrap><fmt:formatNumber value="${paginationInfo.totalRecordCount - ((searchVO.pageIndex-1) * searchVO.pageUnit) - (status.count - 1)}" type="number"/></td>
			...
			<td class="lt_text3" nowrap><a href="/mng/sym/ccm/cca/EgovCcmCmmnCodeList.do?searchCode=<c:out value="${resultInfo.clCode}"/>">하위관리</a></td>
		</tr>   
		</c:forEach>
