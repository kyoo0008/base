...
<div id="cntnts">
        ...
        <form:form commandName="mlgInfo" action="/mng/uss/ion/mlg/updateMlginfo.do" method="post"> 
        
		<input type="hidden" name="updateMlgCode" value="${mlgInfo.mlgCode}"/>
        <fieldset>
          ...
          <div class="btn_r">
          	<a href="javascript:fn_egov_regist()"><img src="${_IMG}/btn/btn_modify.gif" alt="수정" /></a>
