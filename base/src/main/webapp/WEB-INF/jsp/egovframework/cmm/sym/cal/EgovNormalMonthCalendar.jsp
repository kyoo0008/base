...
<form name="normalMonthCalendar" action ="<c:url value='/sym/cal/EgovNormalMonthCalendar.do'/>" method="post">
	...
	<table width="700" cellpadding="8" class="table-search" border="0">
	  <tr>
	    <td width="400" class="title_left"><img src="${pageContext.request.contextPath}/template/common/images/egovframework/cmm/sym/cal/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt="제목"/>&nbsp;일반달력 월간</td>
	  	<td>
	  		<div style={text-align:right;}>
	  		<select name="year" onchange="javascript:fn_egov_change_Calendar(document.normalMonthCalendar);">
	  		...
	  		&nbsp;&nbsp;
	  		<select name="month" onchange="javascript:fn_egov_change_Calendar(document.normalMonthCalendar);">
