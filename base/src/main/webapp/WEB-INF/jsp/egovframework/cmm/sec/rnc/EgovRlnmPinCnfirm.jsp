...
<base target="_self" />
<link rel="stylesheet" href="/css/egovframework/cmm/sec/rnc/com.css" type="text/css">
...
function fnGpinCnfirm(){
    ...
    //open 형태로 호출
    //var w = window.open("/sec/rnc/EgovPageLink.do?link=cmm/sec/rnc/EgovCallGpin", "gPinLoginWin", "directories=no,toolbar=no,left="+wX+",top="+wY+",width="+wWidth+",height="+wHight);
    
    //submit 형태로 호출
    var ww = window.open("#","_openWin", "directories=no,toolbar=no,left="+wX+",top="+wY+",width="+wWidth+",height="+wHight);
    document.cnfirmForm.action="/sec/rnc/EgovPageLink.do?link=cmm/sec/rnc/EgovCallGpin";
...
<body>
        <!-- content start -->
        <form name="cnfirmForm" method="post" >
        ...
        <table width="717" cellpadding="8" class="table-search" border="0">
            ...
            <img src="/images/egovframework/cmm/sec/rnc/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle">&nbsp;공공IPIN 실명확인</td>
            </tr>
        </table>
        <table width="717" border="0"  cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <tr>
                    <!-- 실명확인 -->
	                <td align="right"><img src="/images/egovframework/cmm/sec/rnc/btn/bu2_left.gif" width="8" height="20"></td>
	                <td background="/images/egovframework/cmm/sec/rnc/btn/bu2_bg.gif" class="text_left" nowrap>
	                    <a href="javascript:fnGpinCnfirm();"><spring:message code="button.realname" /></a>
	                </td>
	                <td align="left"><img src="/images/egovframework/cmm/sec/rnc/btn/bu2_right.gif" width="8" height="20"></td>
	                <td>&nbsp;</td>
	                <!-- 주민등록번호 실명확인으로 이동 -->
	                <td align="right"><img src="/images/egovframework/cmm/sec/rnc/btn/bu2_left.gif" width="8" height="20"></td>
	                <td background="/images/egovframework/cmm/sec/rnc/btn/bu2_bg.gif" class="text_left" nowrap>
	                ...
	                <td align="right"><img src="/images/egovframework/cmm/sec/rnc/btn/bu2_left.gif" width="8" height="20"></td>
	                <td background="/images/egovframework/cmm/sec/rnc/btn/bu2_bg.gif" class="text_left" nowrap>
	                    <a href="http://www.g-pin.go.kr/jsp/members/find_id.jsp" target="_blank">아이디찾기</a>
	                </td>
	                <td align="left"><img src="/images/egovframework/cmm/sec/rnc/btn/bu2_right.gif" width="8" height="20"></td>
	                <td>&nbsp;</td>
	                <!-- 비밀번호찾기 -->
	                <td align="right"><img src="/images/egovframework/cmm/sec/rnc/btn/bu2_left.gif" width="8" height="20"></td>
	                <td background="/images/egovframework/cmm/sec/rnc/btn/bu2_bg.gif" class="text_left" nowrap>
	                    <a href="http://www.g-pin.go.kr/jsp/members/find_pw.jsp" target="_blank">비밀번호 찾기</a>
	                </td>
	                <td align="left"><img src="/images/egovframework/cmm/sec/rnc/btn/bu2_right.gif" width="8" height="20"></td>
	                <td>&nbsp;</td>
	                <!-- 공공IPIN센터 -->
                    <td align="right"><img src="/images/egovframework/cmm/sec/rnc/btn/bu2_left.gif" width="8" height="20"></td>
                    <td background="/images/egovframework/cmm/sec/rnc/btn/bu2_bg.gif" class="text_left" nowrap>
                        <a href="http://www.g-pin.go.kr/" target="_blank">공공IPIN센터</a>
                    </td>
                    <td align="left"><img src="/images/egovframework/cmm/sec/rnc/btn/bu2_right.gif" width="8" height="20"></td>
                    <!-- 다음단계 이동 -->
                    <td>&nbsp;</td>
