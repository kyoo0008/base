...
<form:form commandName="cmmnDetailCode" name="cmmnDetailCode" method="post" action="${pageContext.request.contextPath}${_PREFIX}/EgovCcmCmmnDetailCodeModify.do">
...
<table class="chart2">
	<colgroup>
	  ...
	  <tr>
	    ...
	    <td><c:out value="${cmmnDetailCode.codeIdNm}"/></td>
	  </tr> 
	  <tr> 
