...
<form:form commandName="cmmnCode" name="cmmnCode" method="post" action="${pageContext.request.contextPath}${_PREFIX}/EgovCcmCmmnCodeRegist.do">
...
<input type="hidden" name="searchKeyword" value="<c:out value='${searchVO.searchKeyword}'/>"/>
	...
	<div class="btn_r">
		...
		<input type="image" src="<c:url value='/template/common/images/sub/board/btn_drawing.gif'/>" alt="저장" onclick="return fn_egov_regist_CmmnCode(this.form);"/>
