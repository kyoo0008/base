...
<!-- IE
<iframe name="ifcal" src="<c:url value='/sym/cmm/EgovselectNormalCalendar.do'/>" style="width:252px; height:175px;" frameborder=0></iframe>
-->
<!-- FIREFOX -->
<iframe name="ifcal" src="<c:url value='/sym/cmm/EgovselectNormalCalendar.do'/>" style="width:350px; height:350px;" frameborder=0></iframe>
