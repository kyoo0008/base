...
function __dlg_init(bottom) {
	...
	if (!document.all) {
		...
		window.resizeTo(body.offsetWidth + 100, body_height+ 20);
...
<body onload="Init()">
<div class="title">그림 삽입</div>
<!--- new stuff --->
<form action="" method="post" enctype="multipart/form-data">
<table border="0" width="100%" style="padding: 0px; margin: 0px">
  <tbody>
  <tr>
    <td style="width: 7em; text-align: right">이미지 파일:</td>
    <td><input type="file" name="file" id="f_upload" style="width:77%"
      title="Select upload image here" />
       <button name="upload" onclick="return onUpload();"
    	title="Upload image file">업로드</button>
    </td>
  </tr>
  <tr>
    <td style="width: 7em; text-align: right">이미지 URL:</td>
  ...
  <tr>
    <td style="width: 7em; text-align: right">대체 문구:</td>
    <td><input type="text" name="alt" id="f_alt" style="width:99%"
