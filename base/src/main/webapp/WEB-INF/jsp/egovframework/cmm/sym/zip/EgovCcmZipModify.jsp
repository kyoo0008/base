...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <img src="${pageContext.request.contextPath}/images/egovframework/cmm/sym/ccm/icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt="제목">&nbsp;우편번호 수정</td>
 </tr>
</table>
<!-- ------------------------------------------------------------------ 줄간격조정  -->
...
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register">
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >우편번호<img src="${pageContext.request.contextPath}/images/egovframework/cmm/sym/ccm/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td width="80%" nowrap colspan="3">
    	<c:out value='${fn:substring(zip.zip, 0,3)}'/>-<c:out value='${fn:substring(zip.zip, 3,6)}'/>
    </td>
  </tr> 
  <tr> 
    <th width="20%" height="23" class="required_text" nowrap >시도명<img src="${pageContext.request.contextPath}/images/egovframework/cmm/sym/ccm/icon/required.gif" alt="필수"  width="15" height="15"></th>
    <td width="80%" nowrap>
    	<c:out value='${zip.ctprvnNm}'/>
    </td>    
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >시군구명<img src="${pageContext.request.contextPath}/images/egovframework/cmm/sym/ccm/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td width="80%" nowrap>
    	<c:out value='${zip.signguNm}'/>
    </td>    
  </tr> 
  <tr>
    <th width="20%" height="23" class="required_text" nowrap >읍면동명<img src="${pageContext.request.contextPath}/images/egovframework/cmm/sym/ccm/icon/required.gif" alt="필수"  width="15" height="15"></th>          
    <td width="80%" nowrap>
...
<tr> 
  ...
  <td background="${pageContext.request.contextPath}/images/egovframework/cmm/sym/ccm/btn/bu2_bg.gif" class="text_left" nowrap><a href="JavaScript:fn_egov_modify_Zip(document.zip);">저장</a></td>
