...
<link type="text/css" rel="stylesheet" href="${pageContext.request.contextPath}/template/common/css/egovframework/cmm/sym/cal/cal.css" />
	...
	if (varParam.sDate) {
		...
		if(sDate.length == 10) {
			if(pForm.init.value != "OK") {
				pForm.init.value  = "OK";
				varForm.action      = "<c:url value='/sym/cmm/callCal.do'/>";
...
<body>
<form name="Form" action ="<c:url value='/sym/cmm/callCal.do'/>" method="post">
