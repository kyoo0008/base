 ...
 */
   ...
   function changeAreaList(idx, obj){	
	...
	function normalSearch(currentPage){
		...
		var keyword = "";
		var cityText='',countyText='',townText='',orgNm='세종특별자치시평생교육연구원',orgCode='217';
		...
		url = "/search/link/AjaxRequestXML.jsp?getUrl="+escape("http://www.juso.go.kr/link/search.do?extend=true&mode=road_search&searchType=location_buld&topTab=1&engineCtpNm="+encodeURI(cityText)+"&engineSigNm="+encodeURI(countyText)+"&engineEmdNm="+encodeURI(townText)+"&engineBdNm="+encodeURI(trim(form.bdnm.value))+"&currentPage="+currentPage+"&orgCode="+orgCode+"&orgNm="+encodeURI(orgNm));
	...
	function normalSearch2(currentPage){
		var url;
		var form = document.check;
		var orgNm='세종특별자치시평생교육연구원',orgCode='217';
		form.currentPage.value =currentPage;

		currentPage=parseInt((currentPage/10)+1);
				   
		url = "/search/link/AjaxRequestXML.jsp?getUrl="+escape("http://www.juso.go.kr/link/search.do?extend=true&mode=road_search&searchType=location_buld&topTab=1&engineCtpNm="+encodeURI(form.engineCtpNm.value)+"&engineSigNm="+encodeURI(form.engineSigNm.value)+"&engineEmdNm="+encodeURI(form.engineEmdNm.value)+"&engineBdNm="+encodeURI(trim(form.engineBdNm.value))+"&currentPage="+currentPage+"&orgCode="+orgCode+"&orgNm="+encodeURI(orgNm));
