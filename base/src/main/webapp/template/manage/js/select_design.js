...
function makeSelectBoxGlobal(thisId, selectBoxSelectedArea, lineColor, downArrowSrcPath, selectBoxOption, selectBoxSelectedAreaFocus, selectBoxOptionOver) {
	...
	var downArrowSrcWidth = 21;	//rightQrrow Image width
	var optionHeight = 19; // option heigh
	var optionMaxNum = 10; // option Maxnum
	...
	newSelect  = "<table class='cmLayer' id='" + objId + "selectBoxOptionLayer' cellpadding='0' cellspacing='0' border='0' style='position:absolute;z-index:100;display:none;' onMouseOver=\"viewOptionLayer('"+ objId + "')\" onMouseOut=\"setMousePosition('out')\">";
	newSelect += "	<tr>";
	...
	newSelect += "		<table class='cmLayer' cellpadding='0' cellspacing='0' border='0' width='100%'>";
	newSelect += "			<tr>";
	...
	newSelect += "		<table class='cmLayer' cellpadding='0' cellspacing='0' border='0' width='100%' style='table-layout:fixed;word-break:break-all;'>";
	...
	newSelect += "	</tr>";
	newSelect += "</table>";
	newSelect += "<table class='cmLayer' cellpadding='0' cellspacing='1' border='0' bgcolor='"+lineColor+"' onClick=\"viewOptionLayer('"+ objId + "')\" style='cursor:hand;' onMouseOut=\"setMousePosition('out')\">";
	newSelect += "	<tr>";
	newSelect += "		<td bgcolor='#ffffff'>";
	newSelect += "		<table class='cmLayer' cellpadding='0' cellspacing='0' border='0'>";
	newSelect += "			<tr>";
