...
//웹에디터 초기화
_editor_url = "/template/common/html/egovframework/cmm/utl/htmlarea3.0/";
_editor_lang = "kr";

var editor = null;

//var editor_css_path = "/template/common/css/default.css";

var editor_css_path = "/template/common/html/egovframework/cmm/utl/htmlarea3.0/default.css";
...
HTMLArea.Config = function () {
	...
	this.toolbar = [
		...
		[ "justifyleft", "justifycenter", "justifyright", "justifyfull", "separator",
		  ...
		  "inserthorizontalrule", "createlink", "insertimage", "inserttable", "htmlmode", "separator", "about" ]
	];
...
HTMLArea.prototype.generate = function () {
	...
	function initIframe() {
		...
		if (!editor.config.fullPage) {
			...
			html += "<link type='text/css' rel='stylesheet' href='" + editor_css_path + "' />\n";
			//html += "<style>" + editor.config.pageStyle +" html,body {font-size:12px; font-family:'돋움';  letter-spacing:-0.7px;margin:0; padding:0;border: 1px;}</style>\n";
			html += "</head>\n";
			html += "<body>\n";
